...
<html>
<head>
    <title>Snapshot a PhotoGallery Category Flat Bootstrap Responsive website Template | Home :: w3layouts</title>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <meta name="keywords" content="Snapshot Responsive web template, Bootstrap Web Templates, Flat Web Templates, Android Compatible web template,
...
<div class="main">
                    ...
                    <ul class="slides">
                        <li>
                            <div class="banner-w3lstext">
                                <h3>Hello ...</h3>
                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer gravida mauris non mi gravida, at sollicitudin odio efficitur. Mauris ex nulla, aliquam ornare.  </p>
                            </div>
                        </li>
                        <li>
                            <div class="banner-w3lstext">
                                <h3> Iam a</h3>
                                <p>Integer gravida mauris non mi gravida, at sollicitudin odio efficitur. Lorem ipsum dolor sit amet elit consectetur adipiscing, Mauris  aliquam ornare facilisis.  </p>
                            </div>
                        </li>
                        <li>
                            <div class="banner-w3lstext">
                                <h3>Photographer</h3>
                                <p>Mauris ex nulla, aliquam ornare facilisis nec convallis pulvinar a non nunc non leo sollicitudin, Lorem ipsum dolor sit amet, consectetur adipiscing elit. </p>
                            </div>
                        </li>
                    </ul>
                </div>
                ...
                <div class="col-md-8 services-grid-info">
                    <div class="services-grid-row">
                        ...
                        <div class="col-md-6 services-grid services-text">
                            ...
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed tincidunt lorem sed velit fermentum lobortis fusce eu semper lacus, eget placerat mauris. Sed lectus tellus, sodales id elit a, feugiat porttitor nulla.  </p>
                        </div>
                        <div class="clearfix"> </div>
                    </div>
                    <div class="services-grid-row">
    ...
    <div class="footer">
        <div class="container">
            ...
            <p>© 2016 Snapshot. All rights reserved | Design by <a href="http://w3layouts.com">W3layouts</a></p>
        ...
        <div class="half-block">
            ...
            <nav>
                <ul class="primary-navi">
                    ...
                    <li><a href="add_photo.php">My Photos</a></li>
                    <li><a href="view_photo.php">View My Photos</a></li>
                    <li><a href="add_music.php">My Music</a></li>
                    <li><a href="view_music.php">View My Album</a></li>
                    <li><a href="video.php">My Videos</a></li>
                    <li><a href="view_video.php">View My Videos</a></li>
